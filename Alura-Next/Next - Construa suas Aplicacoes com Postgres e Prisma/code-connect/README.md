...
- Garanta que o Docker esteja rodando no seu sistema.
- Configure um arquivo `.env` com o valor de `DATABASE_URL="postgresql://postgres@localhost:5432/codeconnect_dev"`.
- Inicie o serviço de banco de dados com:
...
- Opcional: execute o seed para popular o banco com posts:
...
- `docker-compose down` derruba os containers criados pelo Compose.
- Se o banco precisar ser recriado ou estiver vazio, execute novamente a migração e o seed.
- Se você estiver usando `docker-compose down --volumes`, os dados do banco serão removidos.
