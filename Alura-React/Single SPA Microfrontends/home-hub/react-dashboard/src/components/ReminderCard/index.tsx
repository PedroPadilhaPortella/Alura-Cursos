    ...
    <Card sx={{ background: '#F5F5F5' }}>
      <CardContent>
        ...
        <Box display={'flex'} alignItems={'center'} justifyContent={'start'} sx={{ marginTop: 2 }}>
          <Typography variant='body2'>Agendar exame médico periódico</Typography>
        </Box>
        <Divider sx={{ color: '#000000' }} style={{ marginTop: 8 }} />
        <Box display={'flex'} alignItems={'center'} justifyContent={'start'} sx={{ marginTop: 1 }}>
          <Typography variant='body2'>Atualiza LinkedIn</Typography>
        </Box>
        <Divider sx={{ color: '#000000' }} style={{ marginTop: 8 }} />
        <Box display={'flex'} alignItems={'center'} justifyContent={'start'} sx={{ marginTop: 1 }}>
        ...
        <Divider sx={{ color: '#000000' }} style={{ marginTop: 8 }} />
        <Box display={'flex'} alignItems={'center'} justifyContent={'start'} sx={{ marginTop: 1 }}>
          <Typography variant='body2'>Compras energéticos</Typography>
        </Box>
      </CardContent>
    </Card>
  );
