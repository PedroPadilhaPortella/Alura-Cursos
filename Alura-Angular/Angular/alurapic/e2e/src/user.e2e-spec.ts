import { UserPage } from './pageObjects/user/user.po';
...
function procurarTituloAbstratido(titulo: string) {
...
describe('User Page', () => {
    ...
    it('deve comentar na imagem', () => {
        if (userPage.pegarBotaoDePesquisa()) {
            ...
            expect(userPage.verificarSeFoiComentadoFoiPublicado()).toMatch(comentario);
        }
    });
